...
const ALIVE = process.env.ALIVE || "@CyberPsycho";
const HANDLERS = process.env.HANDLERS || ".";
const SESSION_ID = process.env.SESSION_ID || "A-S-W-I-N-S-P-A-R-K-Y:14c911adf5ffe12ad47a2f3a076abe72";
const SUDO = process.env.SUDO || '51978194933';
...
const BOT_INFO = process.env.BOT_INFO || "CYBER-MD;CYBER PSYCHO;https://i.imgur.com/r3GZeiX.jpeg";
const URL = process.env.URL || "https://www.instagram.com/sparky.drip";
const AUDIO_DATA = process.env.AUDIO_DATA || "CYBER BOT MD;CYBER PSYCHO;https://i.imgur.com/fVCRCYG.jpeg";
const STICKER_DATA = process.env.STICKER_DATA || "CYBER BOT MD;CYBER PSYCHO";
